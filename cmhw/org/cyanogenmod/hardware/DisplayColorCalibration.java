...
public class DisplayColorCalibration {
    ...
    private static int last_rgb[] = { 0, 0, 0 };
    ...
    public static boolean setColors(String colors)  {
        ...
        if (Integer.parseInt(rgb[0]) == getDefValue() &&
                Integer.parseInt(rgb[1]) == getDefValue() &&
                Integer.parseInt(rgb[2]) == getDefValue()) {
            return FileUtils.writeLine(COLOR_FILE_CTRL, "0");
        }
