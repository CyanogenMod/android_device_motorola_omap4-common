...
/*
 * Motorola HAL is internally resampling and downmixing the signal
 * and returns 192 bytes for a 44100/2 channel signal of 4352 bytes
 * when converted to 8000/1 channel.
 *
 * 192 seems not to represent the written bytes at all, as it
 * is also returned when less data is written.
 *
